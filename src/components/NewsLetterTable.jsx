...
const NewsLetterTable = () => {
  const newsletters = Array.from({ length: 50 }).map((_, index) => ({
    id: index + 1,
    title:
  ...
  const totalPages = Math.ceil(newsletters.length / rowsPerPage);
